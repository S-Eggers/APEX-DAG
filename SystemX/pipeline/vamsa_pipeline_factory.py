...
from SystemX.pipeline.vamsa_pipeline import VamsaPipeline
from SystemX.serializer.vamsa_serializer import VamsaMode, VamsaSerializer
...
class VamsaPipelineFactory:
    ...
    def create(request_payload: dict[str, Any]) -> VamsaPipeline:
        ...
        kb_path = os.path.join(current_dir, "..", "vamsa", "data", "knowledge_base.csv")
