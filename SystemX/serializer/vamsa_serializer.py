...
class VamsaSerializer:
    """Serializer for VAMSA supporting direct Cytoscape export (WIR) and reduced lineage visualization (LINEAGE)."""
    ...
    def _serialize_lineage(self, graph: nx.DiGraph) -> VamsaResponse:
        ...
        result = self._format_to_cytoscape(reduced_v)
        result["tuples"] = extract_tuples_from_projected(reduced_v)
        return result
