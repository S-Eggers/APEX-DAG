...
class InsufficientNegativeEdgesError(Exception):
    def __init__(self, message: str = "The graph does not have enough negative edges") -> None:
        self.message = message
        super().__init__(self.message)

class InsufficientPositiveEdgesError(Exception):
    def __init__(self, message: str = "The graph does not have enough negative edges") -> None:
        self.message = message
        super().__init__(self.message)

InsufficientNegativeEdgesException = InsufficientNegativeEdgesError
InsufficientPositiveEdgesException = InsufficientPositiveEdgesError
