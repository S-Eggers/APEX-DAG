...
DATAFLOW_NODES: dict[int, dict[str, str]] = {
    ...
    **_build_metadata_dict("Compute", "#FFA07A", "solid", [("CALL", 9, "Call / Operation")]),
}
...
WIR_EDGES: dict[int, dict[str, str]] = {
    **_build_metadata_dict("Flow", "#FFA07A", "solid", [("CALLER", 0, "Caller")]),
    **_build_metadata_dict("Flow", "#98FB98", "solid", [("INPUT", 1, "Input")]),
    **_build_metadata_dict("Flow", "#B0C4DE", "solid", [("OUTPUT", 2, "Output")]),
}
...
DOMAIN_NODES: dict[int, dict[str, str]] = {
    ...
    **_build_metadata_dict("Data", "#8fbc8f", "solid", [("FEATURE_ENGINEERING", 9, "Feature/Transform")]),
    **_build_metadata_dict("Entities", "#dda0dd", "solid", [("EVALUATION", 10, "Metric/Loss")]),
    **_build_metadata_dict("Data", "#f4a460", "solid", [("ARTIFACT", 11, "Serialized Artifact")]),
    **_build_metadata_dict("Warnings", "#ef4444", "dashed", [("LEAKAGE_DETECTED", 12, "DATA LEAKAGE")]),
    **_build_metadata_dict("Fallback", "#e5e7eb", "dotted", [("DEAD_CODE", 13, "Dead Code / Unused")]),
}

DOMAIN_EDGES: dict[int, dict[str, str]] = {
    **_build_metadata_dict("State", "#ef4444", "solid", [("UNLABELLED", -1, "No Label")]),
    ...
    **_build_metadata_dict("Operations", "#DDA0DD", "solid", [("DATA_TRANSFORM", 2, "Transformation")]),
    ...
    **_build_metadata_dict("Operations", "#cd853f", "solid", [("ARTIFACT_EXPORT", 6, "Artifact Export")]),
    **_build_metadata_dict("Warnings", "#ef4444", "dashed", [("LEAKAGE_DETECTED", 12, "Data Leakage")]),
    **_build_metadata_dict("Fallback", "#e5e7eb", "dotted", [("DEAD_CODE", 13, "Dead Code / Unused")]),
}
...
DOMAIN_LABEL_MERGES: dict[int, int] = {
    DOMAIN_EDGE_TYPES["ARTIFACT_EXPORT"]: DOMAIN_EDGE_TYPES["DATA_EXPORT"],
}

def canonical_domain_label(label: int) -> int:
    """Map a domain-label id to its canonical class (applies DOMAIN_LABEL_MERGES)."""
    return DOMAIN_LABEL_MERGES.get(label, label)
...
COMPUTE_HUBS: Final[set[int]] = {NODE_TYPES["CALL"]}

HUB_NODE_TYPES: Final[set[int]] = {NODE_TYPES["FUNCTION"], NODE_TYPES["LOOP"], NODE_TYPES["CALL"]}
