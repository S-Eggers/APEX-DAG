...
class BaseTrainer:
    ...
    def log_confusion_matrix(self, loader, phase, pred_type="edge_type_preds"):
        ...
        with torch.no_grad():
            for data in tqdm.tqdm(
                loader, desc="Processing Data for conf matrix", leave=False
            ):
        ...
        for epoch in training_bar:
            ...
            if avg_val_loss < self.best_val_loss:
                ...
                self.save_checkpoint(
                    epoch, avg_val_loss, suffix_name=self.graph_transform_mode
                )
            else:
    ...
    def log_embeddings(self, epoch, data, attribute="node_type_preds"):
        ...
        with torch.no_grad():
            ...
            wandb.log(
                {"embeddings": node_embeddings.cpu().data.numpy(), "epoch": epoch}
            )
