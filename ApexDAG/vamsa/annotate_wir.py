...
class KB:
    def __init__(self, knowledge_base=None, kb_cs_path="output/proposals/final_annotation_kb_sklearn.csv"):
        if knowledge_base is not None:
            self.knowledge_base = knowledge_base.knowledge_base
        else:
            self.knowledge_base = pd.read_csv(kb_cs_path)
        # handle none values in the knowledge base
