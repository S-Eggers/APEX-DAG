...
export class SystemXNativeDropdownWidget extends Widget {
  constructor(commands: any) {
    ...
    button.title = 'Open SystemX Views';
    button.setAttribute('aria-label', 'Open SystemX views menu');
